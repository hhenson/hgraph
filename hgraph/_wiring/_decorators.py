...
from typing import TypeVar, Callable, Type, Sequence, TYPE_CHECKING, Mapping, Any, overload
...
def adaptor(fn: SERVICE_DEFINITION = None, resolvers: Mapping["TypeVar", Callable] = None) -> SERVICE_DEFINITION:
    """
    ::
