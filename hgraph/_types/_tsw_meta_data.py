...
class HgTSWTypeMetaData(HgTimeSeriesTypeMetaData):
    ...
    @property
    def cpp_type(self):
        """Get the C++ TSWTypeMeta for this TSW type."""
        ...
        try:
            ...
            if is_time_based:
                # Duration-based window - pass timedelta directly
                # nanobind chrono header will convert to engine_time_delta_t (microseconds)
                ...
                return _hgraph.TSTypeRegistry.instance().tsw_duration(value_cpp, time_range, min_time_range)
            else:
                # Size-based window - extract tick counts
                size = 0
                min_size = 0
                ...
                return _hgraph.TSTypeRegistry.instance().tsw(value_cpp, size, min_size)
