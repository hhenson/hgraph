...
This page records the work that enabled C++-first hgraph 0.8.0 to replace the
Python-first engine, plus remaining post-port work. The C++ runtime remains the
source of truth. It distinguishes four states deliberately:
