...
> **On the "Derived from" markers.** The file-and-line pointers in this part
> cite the Python-first implementation maintained on the `release/0.5` branch,
> where this text was originally written. They record provenance, not the
> current implementation. For the C++ runtime's type representation see
> [`developer_guide/data_structures/schemas/`](../developer_guide/data_structures/schemas/index.rst),
> and for behaviour that intentionally differs see the
> [parity matrix](../developer_guide/parity_matrix.rst).
...
**Derived from:** `release/0.5` `hgraph/_types/_scalar_type_meta_data.py:222-296`
...
**Derived from:** `release/0.5` `hgraph/_types/_scalar_type_meta_data.py:648-1130`
...
**Derived from:** `release/0.5` `hgraph/_types/_scalar_type_meta_data.py:1130-1250`
...
**Derived from:** `release/0.5` `hgraph/_types/_scalar_type_meta_data.py:324-650`
...
**Derived from:** `release/0.5` `hgraph/_types/_scalar_type_meta_data.py:98-220`
...
**Derived from:** `release/0.5` `hgraph/_types/_time_series_meta_data.py:19-92`
...
**Derived from:** `release/0.5` `hgraph/_types/_ts_meta_data.py`
...
**Derived from:** `release/0.5` `hgraph/_types/_tsb_meta_data.py`
...
**Derived from:** `release/0.5` `hgraph/_types/_tsl_meta_data.py`
...
**Derived from:** `release/0.5` `hgraph/_types/_tsd_meta_data.py`
...
**Derived from:** `release/0.5` `hgraph/_types/_tss_meta_data.py`
...
**Derived from:** `release/0.5` `hgraph/_types/_tsw_meta_data.py`
...
**Derived from:** `release/0.5` `hgraph/_types/_ref_meta_data.py`
...
**Derived from:** `release/0.5` `hgraph/_types/_type_meta_data.py:118-133`
...
**Derived from:** `release/0.5` `hgraph/_types/_generic_rank_util.py`
...
**Derived from:** `release/0.5` `hgraph/_types/_type_meta_data.py:83-97`
...
**Derived from:** `release/0.5` `hgraph/_types/_schema_type.py:33-100`
...
**Derived from:** `release/0.5` `hgraph/_types/_tsb_type.py:70-150`
