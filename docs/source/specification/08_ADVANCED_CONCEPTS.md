...
Mixed-numeric overloads of the arithmetic operators, as an application would
declare them:

```python
from hgraph import add_, sub_, mul_, div_, compute_node, TS, NUMBER, NUMBER_2, DivideByZero
