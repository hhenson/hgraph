...
Status: 44 cases compared with Python and C++; user rulings recorded.
...
| All four two-level TSL/TSB combinations, owned / assembled, `*_invalidate` | Populate every leaf; invalidate the owned root or all assembled leaves at t7; every descendant resets to invalid, unmodified, time `never`, nil value/delta at t7 and idle t8 |
