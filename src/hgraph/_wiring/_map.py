...
def _build_map_wiring(
    ...
    match map_type:
        case "TSD":
            ...
            map_wiring_node, sc, cc  = _create_tsd_map_wiring_node(fn, kwargs_, input_types, multiplex_args, no_key_args,
                                                          input_key_tp, input_key_name if input_has_key_arg else None)
        case "TSL":
            from hgraph._types._scalar_type_meta_data import HgAtomicType
            map_wiring_node, sc, cc  = _create_tsl_map_signature(fn, kwargs_, input_types, multiplex_args,
