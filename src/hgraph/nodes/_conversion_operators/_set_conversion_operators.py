...
from hgraph import compute_node, TS, SCALAR, STATE, SCHEDULER, MIN_TD, emit, TSS, collect, DEFAULT, OUT, SIGNAL, TS_OUT, \
    PythonSetDelta, convert, SCALAR_1
...
def collect_set(ts: TS[SCALAR], *, reset: SIGNAL = None, tp_: Type[OUT] = DEFAULT[OUT],
