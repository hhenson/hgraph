...
from hg._runtime._constants import MIN_TD
from hg._runtime._evaluation_clock import EvaluationClock, EngineEvaluationClock
from hg._runtime._evaluation_engine import EvaluationEngine, EvaluationEngineApi, EvaluationLifeCycleObserver


class PythonEvaluationEngine(EvaluationEngine):

    def __init__(self, engine_evaluation_clock: EngineEvaluationClock, start_time: datetime, end_time: datetime):
        super().__init__()
