...
2. [Language model](design/language-model.md) — functions, nominal operators,
   ...
   rolling temporal types, nominal structs, abstract data families, inherited
   defaults, optional fields, sparse deltas, runtime state, lifecycle,
   activation, output, tests and running, and syntax decisions.
