...
TEST_CASE("value functions lift through the public native wiring API", "[codegen][value-function]") {
    ...
    CHECK_OUTPUT(eval_node<value_functions::operators::forward_lift>(values<Float>(1.0, none, 3.0)), values<Float>(2.0, none, 4.0));
    CHECK_OUTPUT(eval_node<value_functions::operators::forward_runtime>(values<Float>(1.0, none, 3.0)),
                 values<Float>(2.0, none, 4.0));
    ...
    CHECK_OUTPUT(eval_node<value_functions::operators::with_sink>(values<Float>(1.0, none, 3.0)), values<Float>(1.0, none, 3.0));
}
