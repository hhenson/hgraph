...
set(_entry "${_cache}/v1/${_original_key}")
...
file(GLOB _quarantined LIST_DIRECTORIES true "${_cache}/v1/.incomplete-*")
if(NOT _quarantined)
...
if(NOT EXISTS "${_entry}/complete" OR NOT EXISTS "${_cache}/v1/${_changed_key}/complete")
...
file(GLOB _parallel_entries LIST_DIRECTORIES true "${_parallel_cache}/v1/[0-9a-f]*")
...
file(GLOB _parallel_staging LIST_DIRECTORIES true "${_parallel_cache}/v1/.staging-*")
