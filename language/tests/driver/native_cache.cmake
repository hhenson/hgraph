...
set(_entry "${_cache}/v3/${_original_key}")
...
if(NOT EXISTS "${_entry}/module.hgl-module.json")
    message(FATAL_ERROR "cold run did not publish its module descriptor")
endif()
...
file(GLOB _quarantined LIST_DIRECTORIES true "${_cache}/v3/.incomplete-*")
if(NOT _quarantined)
...
if(NOT EXISTS "${_entry}/complete" OR NOT EXISTS "${_cache}/v3/${_changed_key}/complete")
...
file(GLOB _parallel_entries LIST_DIRECTORIES true "${_parallel_cache}/v3/[0-9a-f]*")
...
file(GLOB _parallel_staging LIST_DIRECTORIES true "${_parallel_cache}/v3/.staging-*")
