...
from hgraph import TS, CompoundScalar, TimeSeriesSchema, TSB, compute_node, TIME_SERIES_TYPE, TABLE, DEFAULT
...
def _compare(tp, value, table, keys, types, partition_keys=tuple()):
