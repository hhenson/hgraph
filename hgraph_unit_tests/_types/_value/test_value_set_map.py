...
def test_set_add_native_type(int_set_schema):
...
def test_set_add_returns_true_for_new(int_set_schema):
...
def test_set_add_returns_false_for_existing(int_set_schema):
...
def test_set_add_duplicates_dont_increase_size(int_set_schema):
...
def test_set_add_with_value(int_set_schema):
...
def test_set_add_strings(string_set_schema):
...
def test_set_add_wrong_type_raises(int_set_schema):
...
def test_set_large_add_performance(int_set_schema):
