...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "v0.3.2"
  WORKING_DIRECTORY "/Users/hhenson/CLionProjects/hgraph/cpp/tests/build/_deps/tpack-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v0.3.2")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/hhenson/CLionProjects/hgraph/cpp/tests/build/_deps/tpack-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/hhenson/CLionProjects/hgraph/cpp/tests/build/_deps/tpack-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
