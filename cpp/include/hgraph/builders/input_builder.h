...
namespace hgraph {
    ...
    struct InputBuilder : Builder {
         ...
         */
        virtual time_series_input_s_ptr make_instance(node_ptr owning_node) const = 0;

        /**
         * Create an instance of InputBuilder using an parent input
         */
        virtual time_series_input_s_ptr make_instance(time_series_input_ptr owning_input) const = 0;
