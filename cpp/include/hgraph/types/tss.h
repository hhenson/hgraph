...
namespace hgraph {
    ...
    struct TimeSeriesSetOutput : TimeSeriesSet<BaseTimeSeriesOutput> {
        ...
        [[nodiscard]] virtual TimeSeriesValueOutput::s_ptr get_contains_output(const nb::object &item,
    ...
    struct TimeSeriesSetOutput_T final : TimeSeriesSetOutput {
        ...
        [[nodiscard]] TimeSeriesValueOutput::s_ptr get_contains_output(const nb::object &item,
