...
namespace hgraph {
    // Legacy TSValueInput template - stub for migration
    // TODO: Code using this should migrate to ts::TSInput with views
    template<typename T>
    struct TSValueInput : ts::TSInput {
        using ts::TSInput::TSInput;
    };

    // Legacy TSValueOutput template - stub for migration
    // TODO: Code using this should migrate to ts::TSOutput with views
    template<typename T>
    struct TSValueOutput : ts::TSOutput {
