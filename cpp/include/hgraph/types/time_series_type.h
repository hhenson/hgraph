...
namespace hgraph
{
    ...
    // Value-based time-series types (ts namespace)
    namespace ts {
        struct TsInput;
        struct TsOutput;
        struct TsbInput;
    ...
    // Value-based input types (ts namespace)
    using ts_value_input_types = tp::tpack<ts::TsInput, ts::TsbInput, ts::TslInput, ts::TssInput>;
    inline constexpr auto ts_value_input_types_v = ts_value_input_types{};
    ...
    // Value-based output types (ts namespace)
    using ts_value_output_types = tp::tpack<ts::TsOutput, ts::TsbOutput, ts::TslOutput, ts::TssOutput>;
    inline constexpr auto ts_value_output_types_v = ts_value_output_types{};
    ...
    using TimeSeriesInputVisitor =
        decltype(tp::make_v<ddv::mux>(ts_value_input_types_v +  // Value types first for priority matching
                                      ts_input_types_v +
    ...
    using TimeSeriesOutputVisitor =
        decltype(tp::make_v<ddv::mux>(ts_value_output_types_v +  // Value types first for priority matching
                                      ts_output_types_v +
