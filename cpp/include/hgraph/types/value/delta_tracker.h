 ...
 *
 * DeltaTracker observes a KeySet and records which slots were added or
 * removed during a processing cycle. It implements add/remove cancellation:
 ...
 * - Remove then add in same tick = no delta
 */
