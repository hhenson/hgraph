 ...
 * @throws std::runtime_error if navigation fails
 */
inline View navigate_mut(View view, const ValuePath& path) {
    View current = view;
 ...
 * @throws std::runtime_error if parsing or navigation fails
 */
inline View navigate_mut(View view, std::string_view path_str) {
 ...
 */
inline std::optional<View> try_navigate_mut(View view, const ValuePath& path) {
    try {
 ...
 * @return The mutable view at the path destination, or nullopt on failure
 */
inline std::optional<View> try_navigate_mut(View view, std::string_view path_str) {
    try {
        return navigate_mut(view, parse_path(path_str));
    } catch (const std::exception&) {
        return std::nullopt;
