...
namespace keys {
    ...
    inline std::string component_key(const std::string &id_or_label) { return std::string("component::") + id_or_label; }
    inline std::string component_key(int64_t id_or_label) { return std::string("component::") + std::to_string(id_or_label); }
} // namespace keys
