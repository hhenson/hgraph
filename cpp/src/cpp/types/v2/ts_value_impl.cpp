...
namespace hgraph
{
    ...
    void ReferencedTSValue::update_binding() {
        ...
        // TODO: Reference binding integration - requires ref_value_tp and BoundTimeSeriesReference
        // For now, just use a non-bound value since reference support is being added separately
        ...
        //     }
        // }
        throw std::runtime_error("ReferencedTSValue::update_binding not yet implemented - reference support pending");
    }
