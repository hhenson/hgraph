...
namespace hgraph
{
    ...
    void NodeScheduler::register_with_nanobind(nb::module_& m)
    {
        nb::class_ < NodeScheduler, intrusive_base > (m, "NodeScheduler")
                                                     ...
                                                     .def(
                                                         "pop_tag", [](NodeScheduler& self, const std::string& tag)
                                                         {
                                                             return self.pop_tag(tag);
                                                         }, "tag"_a)
                                                     .def(
                                                         "pop_tag",
        ...
        nb::class_ < Node, ComponentLifeCycle > (m, "Node")
                                                ...
                                                .def_prop_ro("inputs",
                                                             [](Node& self)
                                                             {
                                                                 ...
                                                                 for (const auto& key : inp_.schema().keys())
                                                                 {
                                                                     d[key.c_str()] = inp_[key];
                                                                 }
                                                                 return d;
                                                             })
                                                .def_prop_ro("start_inputs",
                                                             ...
                                                             {
                                                                 nb::list l;
                                                                 for (const auto& input : self._start_inputs)
                                                                 {
                                                                     l.append(input);
                                                                 }
                                                                 return l;
                                                ...
                                                .def(
                                                    "notify", [](Node& self, engine_time_t modified_time)
                                                    {
