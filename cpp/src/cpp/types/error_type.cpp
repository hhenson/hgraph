    ...
    void BacktraceSignature::register_with_nanobind(nb::module_& m)
    {
        nb::class_ < BacktraceSignature, CompoundScalar > (m, "BacktraceSignature")
                                                          .def(nb::init<std::string, std::vector<std::string>,
                                                               ...
                                                               nb::arg("wiring_path_name"),
                                                               nb::arg("runtime_path_name"), nb::arg("node_id"))
                                                          .def_ro("name", &BacktraceSignature::name)
                                                          .def_ro("args", &BacktraceSignature::args)
                                                          .def_ro("wiring_path_name",
                                                                  &BacktraceSignature::wiring_path_name)
                                                          .def_ro("runtime_path_name",
                                                                  &BacktraceSignature::runtime_path_name)
    ...
    void NodeError::register_with_nanobind(nb::module_& m)
    {
        nb::class_ < NodeError, CompoundScalar > (m, "NodeError")
                                                 .def(nb::init<std::string, std::string, std::string, std::string,
                                                               std::string, std::string, std::string>(),
                                                      nb::arg("signature_name") = "", nb::arg("label") = "",
                                                      nb::arg("wiring_path") = "",
                                                      nb::arg("error_msg") = "", nb::arg("stack_trace") = "",
                                                      nb::arg("activation_back_trace") = "",
                                                 ...
                                                 .def_static("capture_error",
                                                             nb::overload_cast<
                                                                 const std::exception&, const Node&, const std::string
                                                                 &>(&NodeError::capture_error),
                                                             nb::arg("exception"), nb::arg("node"),
                                                             nb::arg("message") = "")
