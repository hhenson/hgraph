...
namespace hgraph {
    node_ptr TryExceptNodeBuilder::make_instance(const std::vector<int64_t> &owning_graph_id, int64_t node_ndx, std::shared_ptr<void> buffer, size_t* offset) const {
        return _make_instance<TryExceptNode>(buffer, offset, "TryExceptNode", owning_graph_id, node_ndx,
