...
namespace
{
    ...
    static constexpr auto input_v = ddv::serial{
        // V2 wrapper factory - handles V2 ts::TsInput type
        [](ts::TsInput*, ApiPtr<TimeSeriesInput> impl) {
    ...
    static constexpr auto output_v = ddv::serial{
        // V2 wrapper factory - handles V2 ts::TsOutput type
        [](ts::TsOutput*, ApiPtr<TimeSeriesOutput> impl) {
