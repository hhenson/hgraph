...
namespace hgraph
{
    ...
    nb::object PyTimeSeriesOutput::parent_output() const { return wrap_output(impl()->parent_output(), control_block()); }
    ...
    nb::object PyTimeSeriesInput::parent_input() const { return wrap_input(impl()->parent_input(), control_block()); }
