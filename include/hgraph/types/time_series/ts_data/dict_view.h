...
namespace hgraph
{
    ...
    class HGRAPH_CLASS_EXPORT TSDDataView
    {
      public:
        ...
        /** Whether this slot has supplied a value to downstream consumers. */
    ...
    class HGRAPH_CLASS_EXPORT TSDDataMutationView : public TSDDataView
    {
      public:
