...
- date: 2026-07-31T21:01:20+00:00
- host: macOS-26.5.2-arm64-arm-64bit-Mach-O / arm
- CPU: Apple M4 Max
- Python: 3.14.6
- hg_cpp revision: 6373b09a0fe0+dirty
...
|---|---:|---:|---:|
| hg_cpp (`hg-cpp`) | 22.5 | 63.8 | 41.3 |

## Value storage

| profile | axis | hg_cpp peak delta | hg_cpp retained | planned KiB | peak dynamic KiB |
|---|---|---:|---:|---:|---:|
| String arithmetic - long (`type_str_std__long`) | duration | 1.4 +/- 0.0 | 1.4 +/- 0.0 | 1.4 | 0.1 |
| CompoundScalar through Python - long (`type_cs_py__long`) | duration | 1.5 +/- 0.0 | 1.5 +/- 0.0 | 1.2 | 0.1 |
| Fixed tick window - long (`type_tsw_append_evict_std__long`) | duration | 1.4 +/- 0.0 | 1.4 +/- 0.0 | 0.7 | 1.1 |
| Set add/remove - large (`tss_add_remove_std__large`) | live cardinality | 1.7 +/- 0.0 | 1.7 +/- 0.0 | 0.7 | 89.8 |

## Keyed collections

| profile | axis | hg_cpp peak delta | hg_cpp retained | planned KiB | peak dynamic KiB |
|---|---|---:|---:|---:|---:|
| Dense TSD map/reduce - large (`tsd_dense_std__large`) | cardinality | 2.4 +/- 0.0 | 2.4 +/- 0.0 | 2.1 | 348.4 |

## hg_cpp dynamic storage

| profile | axis | hg_cpp peak delta | hg_cpp retained | planned KiB | peak dynamic KiB |
|---|---|---:|---:|---:|---:|
| Dynamic TSL map/reduce - large (`reduce_dynamic_tsl_std__large`) | initial capacity | 4.2 +/- 0.0 | 4.2 +/- 0.0 | 1.9 | 808.3 |
