...
namespace hgraph::fabric
{
    ...
    {
        const Value decoded =
            values.decode(scalar_descriptor<RevisionReference>::value_meta(), encoded);
        const auto fields = decoded.view().as_bundle();
