...
C++-first Kafka services for hgraph, implementing the contract in hg_cpp RFC
...
work without making the core `hg_cpp` package depend on this extension.
...
This is a first-party extension in the hg_cpp monorepo. It remains a separate
...
Wheel builds require the SDK installed by a stable-ABI hg_cpp wheel. The
